...
public class Ball : MonoBehaviour {
    ...
    public void Explosion ()
    {
        ...
        {
            case Color.BLACK:
                Instantiate(black_explo, this.transform.position, Quaternion.identity).GetComponent<Explosion>().DestroyObject();
                break;
            case Color.BLUE:
                Instantiate(blue_explo, this.transform.position, Quaternion.identity).GetComponent<Explosion>().DestroyObject();
                break;
            case Color.GRAY:
                Instantiate(gray_explo, this.transform.position, Quaternion.identity).GetComponent<Explosion>().DestroyObject();
                break;
            case Color.RED:
                Instantiate(red_explo, this.transform.position, Quaternion.identity).GetComponent<Explosion>().DestroyObject();
                break;
            case Color.YELLOW:
                Instantiate(yellow_explo, this.transform.position, Quaternion.identity).GetComponent<Explosion>().DestroyObject();
                break;
        }
    }
